...
var traceVax = {
    x: [18, 18, 15, 15, 18, 24, 15, 15, 23],
    y: ['HepB', 'DTaP', 'Hib', 'PCV13', 'IPV', 'FLU', 'MMR', 'Varicella', 'HepA'],
    name: 'None',
    orientation: 'h',
    textposition: 'auto',
...
var traceEmpty = {
    x: [6, 15, 12, 12, 6, 6, 12, 12, 12],
    y: ['HepB', 'DTaP', 'Hib', 'PCV13', 'IPV', 'FLU', 'MMR', 'Varicella', 'HepA'],
    name: 'Recommeded',
    orientation: 'h',
    textposition: 'auto',
    text: ["1mo-2mo; 6mo-18mo", "15mo-18mo", "12mo-15mo", "12mo-15mo", "6mo-18mo", "> 6mo", "12mo-15mo", "12mo-15mo", "12mo-23mo"],
    type: 'bar',
    marker: {
//      color: ['white smoke'],
